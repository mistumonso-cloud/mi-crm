...
**Instalado en la rama `feature/mis-256-pantalla-de-ventas`.** Ver `CODIGO/MIS-256-pantalla-de-ventas/CODIGO-COMPLETO.md` para el histórico completo de las 3 rondas de auditoría.
