...
| [MIS-20](https://linear.app/mistu-monso/issue/MIS-20) | Pruebas del flujo de supervisión de Marta | [MIS-20-pruebas-flujo-supervision-marta.md](./MIS-20-pruebas-flujo-supervision-marta.md) | Auditoría de plan: GO CONDICIONADO (corregido). Código generado y verificado — pendiente de auditoría de código / instalación en `feature/mis-20-pruebas-flujo-supervision-marta` |
