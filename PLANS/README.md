...
| [MIS-14](https://linear.app/mistu-monso/issue/MIS-14) | Gestión de estados del contacto | [MIS-14-gestion-estados-contacto.md](./MIS-14-gestion-estados-contacto.md) | **v3 implementada y verificada, pendiente de PR/merge/deploy** (Inactivo entra al picker manual, Ganado sale) — rama `feature/mis-14-gestion-estados-contacto` |
